...
module.exports = {
  ...
  callback: (client, interraction) => {
    const select = stringMenuBuilder("starter", "Make a selection").addOptions(
      menuItem(
        "✅",
        "option 2",
      ...
      menuItem("❌", "Test", "Ceci est une commande de test", "stf"),
      menuItem("", "kakou kakou", "Ceci est une commande de test", "aws")
    );
